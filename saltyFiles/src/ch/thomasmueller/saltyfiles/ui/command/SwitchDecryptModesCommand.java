...
/**
 * Switch all Controls enabled used for decrytion and disable those used
 * for encryption.
 * 
 ...
 *  
 */
public class SwitchDecryptModesCommand extends AbstractSwitchCommand
{
	...
	public void doCommand(ActionEvent event)
	{
		...
		boolean isDecryptionMode = ! ((JRadioButton) event.getSource())
				.isSelected();
		
		log.debug("SwitchDecryptModesCommand: isDecryptionMode: " + isDecryptionMode);
		super.switchMode(isDecryptionMode);
